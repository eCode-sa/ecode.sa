...
const CONFIG = {
  ...
  tokens: {
    colors: {
      ...
      secondary_alt1: {
        light: "#7EDDA3", // mint-green
        dark:  "#7EDDA3"
      },
      secondary_alt2: {
        light: "#FFB86C", // soft-orange
        dark:  "#FFB86C"
      },
      secondary_alt3: {
        light: "#FF79C6", // coral-pink
        dark:  "#FF79C6"
      },
      background: { 
        light: "#F3F4F6",
  ...
  // المستخدمون (بيانات تجريبية)
  users: [
    // Shareholders
    { id: "USR_001", name: { ar: "المساهم الاول (متوفي)",              en: "First Shareholder (Deceased)" },      percent: 20, shares: 2000, type: "Individual", voting: true, email: "sh1@ecode.sa", proxy: { ar: "وكيل الورثة", en: "Heirs’ Agent" },  title: { ar: "مساهم", en: "Shareholder" }, isShareholder: true, dept: "DEP_EXEC" },
    { id: "USR_002", name: { ar: "المساهم الثاني (شخص طبيعي)",        en: "Second Shareholder (Natural Person)" },percent: 10, shares: 1000, type: "Individual", voting: true, email: "sh2@ecode.sa", proxy: null,                                    title: { ar: "مساهم", en: "Shareholder" }, isShareholder: true, dept: "DEP_EXEC" },
    { id: "USR_003", name: { ar: "المساهم الثالث (كيان قانوني)",       en: "Third Shareholder (Legal Entity)" },   percent: 30, shares: 3000, type: "Entity",     voting: true, email: "sh3@ecode.sa", proxy: { ar: "ممثل الشركة", en: "Company Representative" }, title: { ar: "مساهم", en: "Shareholder" }, isShareholder: true, dept: "DEP_EXEC" },
    { id: "USR_004", name: { ar: "المساهم الرابع (شخص طبيعي)",        en: "Fourth Shareholder (Natural Person)" },percent: 40, shares: 4000, type: "Individual", voting: true, email: "sh4@ecode.sa", proxy: null,                                    title: { ar: "مساهم", en: "Shareholder" }, isShareholder: true, dept: "DEP_EXEC" },    
    ...
    // Managers & Directors
    { id: "USR_010", name: { ar: "اسم مسؤول الحوكمة والمخاطر والالتزام", en: "Ayman Al-Maghrabi" },             title: { ar: "مسؤول الحوكمة والمخاطر والالتزام / أمين سر المجلس", en: "GRC Officer / Board & Committee Secretary" }, dept: "DEP_GRC", role: "grc_officer", email: "admin@ecode.sa", isExecutive: false, avatar: "../../favicon.png" },
    ...
    { id: "USR_018", name: { ar: "اسم التي بوي",                        en: "Tea Boy Name" },                     title: { ar: "دعم مكتبي", en: "Office Support" },                       dept: "DEP_HR",      role: "support",   email: "teaboy@ecode.sa" },
  ...
  // ربط المستخدمين بسياقات الحوكمة
  userRolesMap: [
    { userId: "USR_010", contexts: [
      ...
      { context: "governance",      role: "grc_officer",               label: { ar: "مسؤول الحوكمة والمخاطر والالتزام", en: "GRC Officer" } }
    ]},
  ...
  // الصلاحيات المالية وحدود التفويض
  financialAuthority: {
    poApproval: [
      ...
      { role: "chairman",  limit: -1,      condition: "unbudgeted_or_above_1m" }
    ],
  ...
  // الأنشطة (من السجل التجاري)
  activities: [
    { code: "465102", name: { ar: "البيع بالجملة للبرمجيات ويشمل الاستيراد",              en: "Wholesale Software Sales Including Import" },                     category: "Software" },
    { code: "474120", name: { ar: "البيع بالتجزئة لألعاب الفيديو وبرامجها وملحقاتها",      en: "Retail Sale of Video Games, Software & Accessories" },           category: "Retail" },
    { code: "474151", name: { ar: "البيع بالتجزئة للبرمجيات",                              en: "Retail Sale of Software" },                                      category: "Retail" },
    { code: "474152", name: { ar: "بيع البرمجيات غير المعدة بناء على الطلب",               en: "Sale of Off-the-Shelf Software" },                               category: "Software" },
    { code: "522931", name: { ar: "الخدمات اللوجستية",                                      en: "Logistics Services" },                                            category: "Logistics" },
    { code: "522934", name: { ar: "وسيط الأجرة عبر التطبيقات",                             en: "Ride-Hailing App Intermediary" },                                 category: "Transportation" },
    { code: "620101", name: { ar: "تكامل الأنظمة",                                         en: "Systems Integration" },                                           category: "IT Services" },
    { code: "620102", name: { ar: "تصميم وبرمجة البرمجيات الخاصة",                        en: "Custom Software Design & Development" },                         category: "Software Development" },
    { code: "620104", name: { ar: "تصميم واجهة وتجربة المستخدم",                          en: "UI/UX Design" },                                                  category: "Design" },
    { code: "620106", name: { ar: "تقنيات الروبوت",                                        en: "Robotics Technologies" },                                         category: "Technology" },
    { code: "620107", name: { ar: "تقنية الطباعة ثلاثية الأبعاد",                         en: "3D Printing Technology" },                                        category: "Technology" },
    { code: "620108", name: { ar: "تقنيات الواقع الاندماجي (الواقع الافتراضي والمعزز)",   en: "Immersive Technologies (VR/AR)" },                                category: "Technology" },
    { code: "620111", name: { ar: "تطوير التطبيقات",                                       en: "Application Development" },                                       category: "Software Development" },
    { code: "620112", name: { ar: "تطوير تطبيقات الألعاب",                                en: "Game Application Development" },                                  category: "Software Development" },
    { code: "620113", name: { ar: "تقنيات الذكاء الاصطناعي",                              en: "Artificial Intelligence Technologies" },                          category: "AI" },
    { code: "620117", name: { ar: "تطبيقات وخدمات ويب نظم المعلومات الجيومكانية",         en: "Geospatial Web Applications & Services" },                        category: "GIS" },
    { code: "620118", name: { ar: "برمجيات الأجهزة الصحية والطبية",                       en: "Medical & Healthcare Device Software" },                          category: "HealthTech" },
    { code: "702011", name: { ar: "منح شهادات المطابقة لنظم الإدارة",                     en: "Issuing Management System Compliance Certificates" },             category: "Governance" },
    { code: "702012", name: { ar: "التحقق من صحة الوثائق والمستندات والبيانات",           en: "Verification of Documents & Data Authenticity" },                 category: "Compliance" },
    { code: "702014", name: { ar: "إعادة تأهيل وهيكلة العمليات الإدارية والمالية والتشغيلية للمنشآت", en: "Rehabilitation & Restructuring of Administrative, Financial & Operational Processes" }, category: "Consulting" },
    { code: "702015", name: { ar: "العلاقات العامة والاتصال",                              en: "Public Relations & Communications" },                             category: "Marketing" },
    { code: "702017", name: { ar: "تقديم خدمات الاستشارات الإدارية العليا",               en: "Executive Management Consulting" },                               category: "Consulting" },
    { code: "731011", name: { ar: "مؤسسات ووكالات الدعاية والإعلان",                      en: "Advertising Agencies" },                                          category: "Marketing" },
    { code: "731012", name: { ar: "أنشطة الخطاطين والرسامين",                             en: "Calligraphy & Illustration Services" },                           category: "Creative" },
    { code: "731013", name: { ar: "تقديم خدمات تسويقية نيابةً عن الغير",                  en: "Marketing Services on Behalf of Others" },                        category: "Marketing" },
    { code: "731014", name: { ar: "الإعلانات الجوية",                                      en: "Aerial Advertising" },                                            category: "Advertising" },
    { code: "731030", name: { ar: "تركيب وتجميع لوحات النيون",                             en: "Installation & Assembly of Neon Boards" },                        category: "Advertising" },
    { code: "823001", name: { ar: "تنظيم وإدارة المعارض والمؤتمرات",                      en: "Exhibition & Conference Management" },                            category: "Events" },
    { code: "823004", name: { ar: "تنظيم وإدارة الحشود",                                   en: "Crowd Management" },                                              category: "Events" },
    { code: "823006", name: { ar: "تشغيل مراكز ومرافق المعارض والمؤتمرات",                en: "Operation of Exhibition & Conference Facilities" },               category: "Events" },
    { code: "823007", name: { ar: "إدارة المسابقات إلكترونياً",                           en: "Electronic Competition Management" },                             category: "Technology" }
  ]
};
